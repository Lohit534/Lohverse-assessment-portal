...
export default function Interviews() {
  ...
  const handleSchedule = async (e) => {
    ...
    try {
      ...
      toast.success('Video interview scheduled successfully! Candidate has been notified.');
      setShowModal(false);
      loadData();
    } catch (err) {
      toast.error(err.response?.data?.error || 'Scheduling failed. Verify candidate details.');
    } finally {
      setSubmitting(false);
    }
  };
